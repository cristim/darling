...
// Private: a descriptor and offset the caller can mmap() the open fork from (Font Book passes the
// second result as the fd and the third as the offset). Not available on Darling.
